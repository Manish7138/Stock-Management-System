...
function UserManagementPage() {
    ...
    const loadUsers = async ()=>{
        setDataLoading(true);
        try {
            const all = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$local$2d$storage$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LocalDB"].getAllUsers();
            setUsers(all);
        } catch (err) {
            console.error(err);
        } finally{
...
//# sourceMappingURL=_96ea9760._.js.map