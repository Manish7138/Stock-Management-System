...
"[project]/lib/local-storage/db.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$local$2d$storage$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeDatabase"])();
            // Check for existing session
            const currentUser = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$local$2d$storage$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LocalDB"].getCurrentUser();
            setUser(currentUser);
            setLoading(false);
        }
    }["AuthProvider.useEffect"], []);
    const login = async (email, password)=>{
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$local$2d$storage$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LocalDB"].loginUser(email, password);
        setUser(user);
    ...
    const register = async (email, password, fullName, role = "investor")=>{
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$local$2d$storage$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LocalDB"].createUser(email, password, fullName, role);
        setUser(user);
        router.push("/dashboard");
    };
    const logout = ()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$local$2d$storage$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LocalDB"].logout();
        setUser(null);
        router.push("/");
    };
...
"use client";
;
const ToastContext = /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"](null);
...
function useToast() {
    _s1();
    const ctx = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"](ToastContext);
...
//# sourceMappingURL=_ef66e712._.js.map