...
function FundDetailPage() {
    ...
    const submitOrder = async ()=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$second$2f$lib$2f$local$2d$storage$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LocalDB"].createTransaction(user.id, fund.id, orderType, amount, units, nav);
            // Optionally create investment record on buy
            if (orderType === 'buy') {
                await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$second$2f$lib$2f$local$2d$storage$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LocalDB"].createInvestment(user.id, fund.id, amount, nav);
            }
            await loadFund();
...
_s(FundDetailPage, "omFaiZZHlLByioLT4Gzpc5e9K1k=", false, function() {
    return [
...
//# sourceMappingURL=Desktop_second_9d23e587._.js.map